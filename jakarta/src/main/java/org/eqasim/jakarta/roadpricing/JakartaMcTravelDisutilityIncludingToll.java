...
class JakartaMcTravelDisutilityIncludingToll implements TravelDisutility {
	...
	JakartaMcTravelDisutilityIncludingToll(final TravelDisutility normalTravelDisutility, final JakartaMcRoadPricingScheme scheme, Config config)
	{
	...
	JakartaMcTravelDisutilityIncludingToll(final TravelDisutility normalTravelDisutility, final JakartaMcRoadPricingScheme scheme,
		...
		} else if (scheme.getType() == JakartaMcRoadPricingScheme.TOLL_TYPE_LINK) {
	...
	public double getLinkTravelDisutility(final Link link, final double time, final Person person, final Vehicle vehicle) 
	{
		...
		if (this.tollCostHandler instanceof DistanceTollCostBehaviour) {
		...
		double hhlIncome = JakartaPredictorUtils.hhlIncome(person, parameters);
			...
			tollCost = tollCost *EstimatorUtils.interaction( hhlIncome, 
					5327, -0.06);
		}
