...
public final class JakartaMcCalcAverageTolledTripLength implements LinkEnterEventHandler, PersonArrivalEventHandler, VehicleEntersTrafficEventHandler, VehicleLeavesTrafficEventHandler {
	...
	private JakartaMcRoadPricingScheme scheme = null;
    ...
    @Inject
	public JakartaMcCalcAverageTolledTripLength(final Network network, final JakartaMcRoadPricingScheme scheme, EventsManager events) {
		this.scheme = scheme;
